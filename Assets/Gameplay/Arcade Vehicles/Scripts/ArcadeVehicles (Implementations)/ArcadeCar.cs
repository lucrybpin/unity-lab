...
public class ArcadeCar : MonoBehaviour, IArcadeVehicle
{
    ...
    [Header("IArcadeVehicle")]
    [field: SerializeField] public float Torque                     { get; private set; } = 170;
    [field: SerializeField] public float TopSpeed                   { get; private set; } = 70;
    [field: SerializeField] public float MaxSteeringAngle           { get; private set; } = 30f;
    [field: SerializeField] public float BrakeAcceleration          { get; private set; } = 480;
